...
const TopContributor = ({ image, name, subs, id }) => {
  return (
    <div className="xl:flex text-center  hover:border-gray-300 border-2 hover:scale-[1.02] duration-500 items-center bg-white shadow-lg rounded-lg p-4 max-w-md mx-auto">
      <img
        className="w-16 inline h-16 rounded-full object-cover mr-4"
